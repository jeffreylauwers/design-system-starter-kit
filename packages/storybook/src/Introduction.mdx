...
**73 componenten totaal**: alle beschikbaar als HTML/CSS én React.
...
- **Drawer**: Zijpaneel dat vanuit links of rechts de viewport inschuift voor subtaken en contextuele inhoud: modaal of non-modaal, op basis van het native `<dialog>` element
...
- **Options**: Checkbox, Radio, OptionLabel, CheckboxOption, RadioOption, CheckboxGroup, RadioGroup
...
**Versie:** 3.3.0 | **Laatste update:** 2 september 2026 | **Auteur:** Jeffrey Lauwers
